#!/usr/bin/env python
#
#	This script mutes a call  (call_reference)	- doesn't work!
#
#	# 	Get status: 
# curl --digest -k -X GET https://Test:Test@10.1.0.14/polling/callstateHandler
#
# 	Answer call: 
# curl --digest -u Test:Test -d $'<PolycomIPPhone><Data priority="Critical">CallAction:MicMute;nCallReference=0x411cbc80</Data></PolycomIPPhone>' --header "Content-Type: application/x-com-polycom-spipx" https://10.1.0.14/push
#
#
...
# Set call from phone_ip_2 (line 202) on mute

api_url = 'https://{}/push' .format(phone_ip)
s_headers = {'Content-Type': 'application/x-com-polycom-spipx'}
s_data = ' <PolycomIPPhone><Data priority="Critical">CallAction:micmute;nCallReference={}</Data></PolycomIPPhone> ' .format(values.text)

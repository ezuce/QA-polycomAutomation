...
#	4. Place the call on hold from vvx500
#	5. Unhold the call vrom vvx500
#	6. End the call from vvx600
#
# 	Place call: 
...
time.sleep(3)
# Putting call on hold on phone_ip_2 (line 202)
print '-------------- Putting call on hold on {} -------------- \n' .format(phone_ip_2)

api_url = 'https://{}/push' .format(phone_ip_2)
s_headers = {'Content-Type': 'application/x-com-polycom-spipx'}
s_data = ' <PolycomIPPhone><Data priority="Critical">CallAction:Hold;nCallReference={}</Data></PolycomIPPhone> ' .format(values.text)
...
time.sleep(3)
# Resuming a call on phone_ip_2 (line 202)
print '-------------- Resuming call on {} -------------- \n' .format(phone_ip_2)

api_url = 'https://{}/push' .format(phone_ip_2)
s_headers = {'Content-Type': 'application/x-com-polycom-spipx'}
s_data = ' <PolycomIPPhone><Data priority="Critical">CallAction:Resume;nCallReference={}</Data></PolycomIPPhone> ' .format(values.text)
...
time.sleep(3)
# End call on phone_ip_2 (line 202)
print '-------------- Ending call. -------------- \n'

api_url = 'https://{}/push' .format(phone_ip_2)
s_headers = {'Content-Type': 'application/x-com-polycom-spipx'}
s_data = ' <PolycomIPPhone><Data priority="Critical">CallAction:EndCall;nCallReference={}</Data></PolycomIPPhone> ' .format(values.text)
